...
int ShapeAdmin(board *bp,int a)
{
    ...
    for(di=0; di<4; di++)
    {
                ...
                if(n!=0)
                {
                    ...
                    if(bp->connect[1-who][n-1].list[index].p1==block1)
                    {
                        ...
                        else
                        {
                            ...
                            bp->connect[1-who][n-1].list[index].Six[2]=howWhole(bp,bp->connect[1-who][n-1].list[index]);
                        }
                    }
                    else
                    {
        ...
        if(n1+n2)
        {
            ...
            t.tag='n';
            if(t.GreatStatus[0]!='D'||t.SmallStatus[0]!='D')
...
int GenerateMoves(board *bp,SLNode **head)///win=PositiveInfinity,lose=-2,defend_ok=1 or 2,normal=0,no vac=666
{
